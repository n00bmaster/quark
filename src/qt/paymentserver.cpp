...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click bitloonie: links)
...
{
    // clicking on bitloonie: URLs creates FileOpen events on the Mac:
